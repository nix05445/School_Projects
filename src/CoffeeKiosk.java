...
/**
 * This class implements the user menus for the 
 * CoffeeKiosk application (CISC 230 - Lab 4).
 * You should start by commenting everything out to test 
 * your code.  But when you submit this file needs to be 
